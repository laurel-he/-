...
<?php 
 ...
 // 回调地址
 $url = urlencode("http://hexiaojiao.top/weixin/index.php");
 // 公众号的id和secret
 ...
 if(!isset($_GET['code']) && !isset($_SESSION['code'])){
  echo
  '<a href="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxb00a8604f49a4ca6
